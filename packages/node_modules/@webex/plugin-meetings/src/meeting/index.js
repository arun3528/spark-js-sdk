...
import {MeetingNotActiveError, UserInLobbyError, CreateMeetingsError, NoMediaEstablishedYetError, UserNotJoinedError} from '../util/webex-errors';
          ...
          return new Promise((resolve, reject) => {
            ...
            const stabilityTimeout = setTimeout(() => {
              if (peerConnection.connectionState !== CONNECTION_STATE.CONNECTED) {
                ...
                reject(new CreateMeetingsError(30202, 'Meeting connection failed'));
              }
              else {
                LoggerProxy.logger.info(`${LOG_HEADER} PeerConnection CONNECTED`);
                resolve(peerConnection);
